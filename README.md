...
This project demonstrates how to build a **stateful, distributed chatbot system** with proper coordination between user input, AI generation, and streaming responses. It showcases patterns commonly used in production AI systems while keeping the implementation clean and understandable.
